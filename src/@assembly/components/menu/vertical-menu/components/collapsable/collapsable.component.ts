...
@Component({
    selector       : 'asm-vertical-menu-collapsable-item',
    templateUrl    : './collapsable.component.html',
    styles         : [],
    animations     : AsmAnimations,
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class AsmVerticalMenuCollapsableItemComponent implements OnInit, OnDestroy
{
    // Item
    @Input()
    item: any;
    ...
    // Expanded
    @HostBinding('class.asm-vertical-menu-item-expanded')
    isExpanded: boolean;
    ...
    ngOnInit(): void
    {
        ...
        else
        {
            ...
            if ( this._asmVerticalMenuService.autoCollapse )
            {
                this.collapse();
            }
        }
        ...
        this._asmVerticalMenuService.onCollapsableItemCollapsed
        ...
        if ( this._asmVerticalMenuService.autoCollapse )
        {
            this._asmVerticalMenuService.onCollapsableItemExpanded
                .pipe(takeUntil(this._unsubscribeAll))
    ...
    collapse(): void
    {
        ...
        this._asmVerticalMenuService.onCollapsableItemCollapsed.next(this.item);
    }
    ...
    expand(): void
    {
        ...
        // Execute the observable
        this._asmVerticalMenuService.onCollapsableItemExpanded.next(this.item);
    }
