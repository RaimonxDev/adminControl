...
export class AngularMaterialDocViewerComponent implements OnDestroy
{
    ...
    private _fetchDocument(url: string): void
    {
    ...
    private showError(url: string, error: HttpErrorResponse): void
    {
        console.log(error);
    ...
    private _loadComponents(componentName: string, componentClass: any): void
    {
    ...
    private _clearLiveExamples(): void
    {
