        ...
        <div class="w-full max-w-320 mx-auto px-6 md:px-8">
            <div class="py-8">
                ...
                <ng-container *ngIf="overview.options[overview.selectedOption] as selectedOption">
                    <div>
                        <!-- Preview -->
                        <div class="mt-10 h-192 ring-1 ring-gray-300 shadow-xl rounded-lg overflow-auto">
                            <div class="flex flex-auto min-h-full">
                                <!-- Navigation -->
                                <div class="hidden md:block sticky top-0 flex-0 w-56 h-192 border-r border-gray-300 bg-gray-200">
                                    <div class="h-4"></div>
                                    <div class="w-2/3 h-4 m-6 rounded bg-gray-300"></div>
                                    <div class="w-3/4 h-4 m-6 rounded bg-gray-300"></div>
                                    <div class="w-2/3 h-4 m-6 rounded bg-gray-300"></div>
                                    <div class="w-1/2 h-4 m-6 rounded bg-gray-300"></div>
                                    <div class="w-2/3 h-4 m-6 rounded bg-gray-300"></div>
                                </div>
                                <!-- Content -->
                                <div class="flex flex-col flex-auto">
                                    <!-- Header -->
                                    <div class="flex items-center justify-end h-16 px-6 sm:px-10 border-b border-gray-300 bg-gray-200 z-10">
                                    ...
                                    <!-- Footer -->
                                    <div class="flex items-center h-14 px-6 sm:px-10 border-t border-gray-300 bg-gray-200 z-10">
                                        <div class="w-32 h-4 rounded-full bg-gray-300"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
