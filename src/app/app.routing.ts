  ...
  // Admin routes
  {
    ...
    children: [
        ...
        children: [
          {
            path: 'create',
            loadChildren: () =>
              import('app/modules/admin/pedidos/pedidos.module').then(
                (m) => m.PedidosModule
              ),
          },
          {
            ...
            loadChildren: () =>
              import(
                'app/modules/admin/shipped-order/shipped-order.module'
              ).then((m) => m.ShippedOrderModule),
          },
        ],
      },
      {
      ...
      },
      {
        path: 'inventory',
        loadChildren: () =>
          import('app/modules/admin/inventory/inventory.module').then(
            (m) => m.InventoryModule
          ),
      },
      // 404 & Catch all
